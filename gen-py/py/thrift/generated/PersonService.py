...
class Client(Iface):
    ...
    def recv_savePerson(self):
        ...
        result.read(iprot)
        iprot.readMessageEnd()
        if result.dataExceptions is not None:
            raise result.dataExceptions
        return
...
class Processor(Iface, TProcessor):
    ...
    def process_savePerson(self, seqid, iprot, oprot):
        ...
        try:
            ...
            raise
        except DataException as dataExceptions:
            msg_type = TMessageType.REPLY
...
class savePerson_result(object):
    ...
    def __init__(self, dataExceptions=None,):
        self.dataExceptions = dataExceptions
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 1:
                if ftype == TType.STRUCT:
                    self.dataExceptions = DataException()
                    self.dataExceptions.read(iprot)
                else:
                    iprot.skip(ftype)
            else:
                iprot.skip(ftype)
    ...
    def write(self, oprot):
        ...
        if self.dataExceptions is not None:
            oprot.writeFieldBegin('dataExceptions', TType.STRUCT, 1)
            self.dataExceptions.write(oprot)
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
        oprot.writeStructEnd()
...
savePerson_result.thrift_spec = (
    None,  # 0
    (1, TType.STRUCT, 'dataExceptions', [DataException, None], None, ),  # 1
)
