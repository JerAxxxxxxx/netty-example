...
@javax.annotation.Generated(value = "Autogenerated by Thrift Compiler (0.13.0)", date = "2019-12-12")
public class PersonService {
  ...
  public static class Client extends org.apache.thrift.TServiceClient implements Iface {
    ...
    public void recv_savePerson() throws DataException, org.apache.thrift.TException
    {
      ...
      if (result.dataExceptions != null) {
        throw result.dataExceptions;
      }
      return;
    }
  ...
  public static class Processor<I extends Iface> extends org.apache.thrift.TBaseProcessor<I> implements org.apache.thrift.TProcessor {
    ...
    public static class savePerson<I extends Iface> extends org.apache.thrift.ProcessFunction<I, savePerson_args> {
      ...
      public savePerson_result getResult(I iface, savePerson_args args) throws org.apache.thrift.TException {
        ...
        } catch (DataException dataExceptions) {
          result.dataExceptions = dataExceptions;
        }
        return result;
      }
    }
      ...
      public org.apache.thrift.async.AsyncMethodCallback<Void> getResultHandler(final org.apache.thrift.server.AbstractNonblockingServer.AsyncFrameBuffer fb, final int seqid) {
        ...
        return new org.apache.thrift.async.AsyncMethodCallback<Void>() { 
          ...
          public void onError(Exception e) {
            ...
            savePerson_result result = new savePerson_result();
            if (e instanceof DataException) {
              result.dataExceptions = (DataException) e;
              result.setDataExceptionsIsSet(true);
              msg = result;
            } else if (e instanceof org.apache.thrift.transport.TTransportException) {
              _LOGGER.error("TTransportException inside handler", e);
              fb.close();
  ...
  public static class savePerson_result implements org.apache.thrift.TBase<savePerson_result, savePerson_result._Fields>, java.io.Serializable, Cloneable, Comparable<savePerson_result>   {
    ...
    private static final org.apache.thrift.protocol.TField DATA_EXCEPTIONS_FIELD_DESC = new org.apache.thrift.protocol.TField("dataExceptions", org.apache.thrift.protocol.TType.STRUCT, (short)1);
    ...
    public @org.apache.thrift.annotation.Nullable DataException dataExceptions; // required

    /** The set of fields this struct contains, along with convenience methods for finding and manipulating them. */
    public enum _Fields implements org.apache.thrift.TFieldIdEnum {
      DATA_EXCEPTIONS((short)1, "dataExceptions");
    ...
    static {
      java.util.Map<_Fields, org.apache.thrift.meta_data.FieldMetaData> tmpMap = new java.util.EnumMap<_Fields, org.apache.thrift.meta_data.FieldMetaData>(_Fields.class);
      tmpMap.put(_Fields.DATA_EXCEPTIONS, new org.apache.thrift.meta_data.FieldMetaData("dataExceptions", org.apache.thrift.TFieldRequirementType.DEFAULT, 
          new org.apache.thrift.meta_data.StructMetaData(org.apache.thrift.protocol.TType.STRUCT, DataException.class)));
      metaDataMap = java.util.Collections.unmodifiableMap(tmpMap);
    ...
    public savePerson_result(
      DataException dataExceptions)
    {
      this();
      this.dataExceptions = dataExceptions;
    }
    ...
    public savePerson_result(savePerson_result other) {
      if (other.isSetDataExceptions()) {
        this.dataExceptions = new DataException(other.dataExceptions);
      }
    }
    ...
    @Override
    public void clear() {
      this.dataExceptions = null;
    }

    @org.apache.thrift.annotation.Nullable
    public DataException getDataExceptions() {
      return this.dataExceptions;
    }

    public savePerson_result setDataExceptions(@org.apache.thrift.annotation.Nullable DataException dataExceptions) {
      this.dataExceptions = dataExceptions;
      return this;
    }

    public void unsetDataExceptions() {
      this.dataExceptions = null;
    }

    /** Returns true if field dataExceptions is set (has been assigned a value) and false otherwise */
    public boolean isSetDataExceptions() {
      return this.dataExceptions != null;
    }

    public void setDataExceptionsIsSet(boolean value) {
      if (!value) {
        this.dataExceptions = null;
      }
    }
    ...
    public void setFieldValue(_Fields field, @org.apache.thrift.annotation.Nullable Object value) {
      switch (field) {
      case DATA_EXCEPTIONS:
        if (value == null) {
          unsetDataExceptions();
        } else {
          setDataExceptions((DataException)value);
        }
        break;
    ...
    public boolean equals(savePerson_result that) {
      ...
      boolean this_present_dataExceptions = true && this.isSetDataExceptions();
      boolean that_present_dataExceptions = true && that.isSetDataExceptions();
      if (this_present_dataExceptions || that_present_dataExceptions) {
        if (!(this_present_dataExceptions && that_present_dataExceptions))
          return false;
        if (!this.dataExceptions.equals(that.dataExceptions))
          return false;
      }
    ...
    public int hashCode() {
      ...
      hashCode = hashCode * 8191 + ((isSetDataExceptions()) ? 131071 : 524287);
      if (isSetDataExceptions())
        hashCode = hashCode * 8191 + dataExceptions.hashCode();
    ...
    public int compareTo(savePerson_result other) {
      ...
      lastComparison = Boolean.valueOf(isSetDataExceptions()).compareTo(other.isSetDataExceptions());
      if (lastComparison != 0) {
        return lastComparison;
      }
      if (isSetDataExceptions()) {
        lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.dataExceptions, other.dataExceptions);
        if (lastComparison != 0) {
          return lastComparison;
        }
      }
    ...
    public String toString() {
      ...
      sb.append("dataExceptions:");
      if (this.dataExceptions == null) {
        sb.append("null");
      } else {
        sb.append(this.dataExceptions);
      }
      first = false;
      sb.append(")");
      return sb.toString();
    ...
    private static class savePerson_resultStandardScheme extends org.apache.thrift.scheme.StandardScheme<savePerson_result> {
      ...
      public void read(org.apache.thrift.protocol.TProtocol iprot, savePerson_result struct) throws org.apache.thrift.TException {
        ...
        while (true)
        {
          ...
          switch (schemeField.id) {
            case 1: // DATA_EXCEPTIONS
              if (schemeField.type == org.apache.thrift.protocol.TType.STRUCT) {
                struct.dataExceptions = new DataException();
                struct.dataExceptions.read(iprot);
                struct.setDataExceptionsIsSet(true);
              } else { 
                org.apache.thrift.protocol.TProtocolUtil.skip(iprot, schemeField.type);
              }
              break;
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, savePerson_result struct) throws org.apache.thrift.TException {
        ...
        oprot.writeStructBegin(STRUCT_DESC);
        if (struct.dataExceptions != null) {
          oprot.writeFieldBegin(DATA_EXCEPTIONS_FIELD_DESC);
          struct.dataExceptions.write(oprot);
          oprot.writeFieldEnd();
        }
        oprot.writeFieldStop();
        oprot.writeStructEnd();
